    ...
    <div className="mb-8">
      ...
      <div className="text-center text-neutral-300 text-base">
        ...
        <div className="w-full mt-10 text-center text-sm text-neutral-500">
          <p>
            © {new Date().getFullYear()} Anjali Mahida. Built with ❤️, coded in React, and deployed on <a href="https://vercel.com/" className="underline hover:text-neutral-400">Vercel</a>.
          </p>
        </div>
      </div>
    </div>
